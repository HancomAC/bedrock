...
export declare function auth(cb: Handler, permission: Object): (req: any, res: any) => Promise<import("../types/response").ResponseSuccess<any> | import("../types/response").ResponseError<any>>;
